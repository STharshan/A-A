...
​`,
  ...
  {
    title: "ECU Remapping",
    desc: `Process of modifying a vehicle's engine control unit to optimize performance, fuel efficiency, or throttle response.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-60 object-cover"
                    onError={(e) => {
